...
function browse(path) { window.location.href = 'music.html?' + zone_arg + "&mpath=" + path + "&action=Browse"; }
...
function play(path){ window.location.href = "playing.html?" + zone_arg + "action=PlayMusic&mpath=" + path; }
function add(path) { window.location.href = "playing.html?" + zone_arg + "action=AddMusic&mpath=" + path; }
